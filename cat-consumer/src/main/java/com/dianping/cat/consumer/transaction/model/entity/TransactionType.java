...
public class TransactionType extends BaseEntity<TransactionType> {
   ...
   private transient Map<Integer, Range2> m_range2s = new LinkedHashMap<Integer, Range2>();

   private transient Map<Integer, AllDuration> m_allDurations = new LinkedHashMap<Integer, AllDuration>();
