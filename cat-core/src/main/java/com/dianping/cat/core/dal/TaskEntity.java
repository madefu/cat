...
public class TaskEntity {
   ...
   public static final QueryDef UPDATE_DOING_TO_FAIL = new QueryDef("updateDoingToFail", TaskEntity.class, QueryType.UPDATE, 
      "UPDATE <TABLE/> SET <FIELD name='status'/>=4, <FIELD name='end-date'/>=${end-dat e}, <FIELD name='failure-count'/> = <FIELD name='failure-count'/> + 1 WHERE <FIELD name='status'/> = 2 AND <FIELD name='id'/> = ${id};");
