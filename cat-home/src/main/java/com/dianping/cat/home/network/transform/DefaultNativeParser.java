      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              m_linker.onInterface(connection, interface_);
            } else if (_type == 2) {
      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              m_linker.onNetTopology(netGraph, netTopology);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 NetTopology netTopology = new NetTopology();
      ...
      switch (_field) {
         case 33:
            if (_type == 1) { 
              ...
              m_linker.onNetGraph(netGraphSet, netGraph);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 NetGraph netGraph = new NetGraph();
      ...
      switch (_field) {
         ...
         case 33:
            if (_type == 1) { 
              ...
              visitAnchor(anchor);
              m_linker.onAnchor(netTopology, anchor);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Anchor anchor = new Anchor();
         ...
         case 34:
            if (_type == 1) { 
              ...
              visitSwitch(switch_);
              m_linker.onSwitch(netTopology, switch_);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Switch switch_ = new Switch();
         ...
         case 35:
            if (_type == 1) { 
              ...
              m_linker.onConnection(netTopology, connection);
            } else if (_type == 2) {
               for (int i = readInt(); i > 0; i--) {
                 Connection connection = new Connection();
